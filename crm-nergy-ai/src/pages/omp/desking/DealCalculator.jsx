    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
            ...
            <span style={{ fontSize: '0.75rem', color: '#94a3b8' }}>Payment-First Desking Tool</span>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '380px 1fr', gap: '1.5rem' }}>
        ...
        <div style={{ backgroundColor: 'rgba(15, 23, 42, 0.75)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '12px', padding: '1.25rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div style={{ fontSize: '0.88rem', fontWeight: 700, color: '#f8fafc', borderBottom: '1px solid rgba(255, 255, 255, 0.06)', paddingBottom: '0.5rem' }}>
            Deal Parameters & Inputs
          </div>

          <div>
            <label style={{ display: 'block', fontSize: '0.75rem', color: '#94a3b8', marginBottom: '0.25rem' }}>Vehicle Sale Price ($)</label>
            <input
              type="number"
              value={vehiclePrice}
              onChange={(e) => setVehiclePrice(Number(e.target.value))}
              style={{ width: '100%', backgroundColor: 'rgba(30, 41, 59, 0.6)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '6px', padding: '0.5rem 0.75rem', color: '#f8fafc', fontSize: '0.9rem', outline: 'none' }}
            />
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
            <div>
              <label style={{ display: 'block', fontSize: '0.75rem', color: '#94a3b8', marginBottom: '0.25rem' }}>Cash Down ($)</label>
              <input
                type="number"
                value={downPayment}
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.75rem', color: '#94a3b8', marginBottom: '0.25rem' }}>APR Rate (%)</label>
              <input
                type="number"
                step="0.1"
                value={interestRate}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
            <div>
              <label style={{ display: 'block', fontSize: '0.75rem', color: '#94a3b8', marginBottom: '0.25rem' }}>Trade Value ($)</label>
              <input
                type="number"
                value={tradeValue}
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.75rem', color: '#94a3b8', marginBottom: '0.25rem' }}>Trade Payoff ($)</label>
              <input
                type="number"
                value={tradePayoff}
          ...
          <div>
            <label style={{ display: 'block', fontSize: '0.75rem', color: '#94a3b8', marginBottom: '0.35rem' }}>
              Loan Term: <strong style={{ color: '#38bdf8' }}>{termMonths} Months</strong>
            </label>
              ...
              {[36, 48, 60, 72, 84].map((t) => (
                <button
                  ...
                  style={{
                    flex: 1,
                    padding: '0.4rem 0',
                    backgroundColor: termMonths === t ? '#0284c7' : 'rgba(30, 41, 59, 0.6)',
                    color: termMonths === t ? '#fff' : '#94a3b8',
          ...
          <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.4)', padding: '0.75rem', borderRadius: '8px', fontSize: '0.75rem', color: '#94a3b8', display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Doc / Dealer Fee:</span>
              <span style={{ color: '#f8fafc' }}>${docFee}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Sales Tax ({salesTaxRate}%):</span>
              <span style={{ color: '#f8fafc' }}>${salesTax.toFixed(2)}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '0.35rem', fontWeight: 700 }}>
              <span style={{ color: '#f8fafc' }}>Total Amount Financed:</span>
              <span style={{ color: '#38bdf8' }}>${totalAmountToFinance.toFixed(2)}</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '1fr 1fr', gap: '1rem' }}>
          ...
          <div style={{ backgroundColor: 'rgba(15, 23, 42, 0.85)', border: '1px solid #38bdf8', borderRadius: '12px', padding: '1.25rem', position: 'relative', boxShadow: '0 0 20px rgba(56, 189, 248, 0.1)' }}>
            <span style={{ position: 'absolute', top: '12px', right: '12px', fontSize: '0.65rem', padding: '0.15rem 0.45rem', borderRadius: '4px', backgroundColor: 'rgba(56, 189, 248, 0.2)', color: '#38bdf8', fontWeight: 700 }}>
              RECOMMENDED
            </span>
            <span style={{ fontSize: '0.75rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase' }}>
              Option 1: Bank Financing
            </span>
            <div style={{ fontSize: '2.2rem', fontWeight: 800, color: '#38bdf8', marginTop: '0.5rem' }}>
              ${monthlyPayment.toFixed(0)} <span style={{ fontSize: '0.9rem', color: '#94a3b8', fontWeight: 500 }}>/ mo</span>
            </div>
            <div style={{ fontSize: '0.8rem', color: '#cbd5e1', marginTop: '0.5rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
          ...
          <div style={{ backgroundColor: 'rgba(15, 23, 42, 0.75)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '12px', padding: '1.25rem' }}>
            ...
            <div style={{ fontSize: '2.2rem', fontWeight: 800, color: '#f59e0b', marginTop: '0.5rem' }}>
              ${bhphWeeklyPayment.toFixed(0)} <span style={{ fontSize: '0.9rem', color: '#94a3b8', fontWeight: 500 }}>/ week</span>
            </div>
            <div style={{ fontSize: '0.8rem', color: '#cbd5e1', marginTop: '0.5rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
          ...
          <div style={{ backgroundColor: 'rgba(15, 23, 42, 0.75)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '12px', padding: '1.25rem' }}>
            ...
            <div style={{ fontSize: '2.2rem', fontWeight: 800, color: '#a855f7', marginTop: '0.5rem' }}>
              ${((monthlyPayment * 0.74)).toFixed(0)} <span style={{ fontSize: '0.9rem', color: '#94a3b8', fontWeight: 500 }}>/ mo</span>
            </div>
            <div style={{ fontSize: '0.8rem', color: '#cbd5e1', marginTop: '0.5rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
